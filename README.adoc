...
You can easily model complex logic in BPMN, and Adhesive will execute it for
you taking care of parallelism, joining, etc. using the standard BPMN notation.

Since it's small, it can easily be embedded in containers, or replace complex
scripts.
