...
register_transition('done', ActiveEventState.RUNNING, ActiveEventState.DONE)
...
register_transition('done_check', ActiveEventState.WAITING, ActiveEventState.DONE_CHECK)
